module runtimes.mindrt.dstubs;

import runtimes.mindrt.common;
import runtimes.mindrt.util;
...
mixin(Stub!("void* alloca(int s)"));
mixin(Stub!("void _D9invariant12_d_invariantFC6ObjectZv()"));
mixin(Stub!("void _D15TypeInfo_Struct6__vtblZ()"));
mixin(Stub!("void _D17TypeInfo_Delegate6__vtblZ()"));
mixin(Stub!("void _D16TypeInfo_Typedef6__vtblZ()"));
mixin(Stub!("void _D10TypeInfo_i6__initZ()"));
mixin(Stub!("void _D13TypeInfo_Enum6__vtblZ()"));
